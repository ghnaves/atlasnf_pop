...
```{r}
pop_total<-read_rds('data/processed/pop_total_nf.rds')

temp_numeric<-list(
    pop1970=pop_total[pop_total$sit=='Total',"1970"]%>%pull(),
    pop2010=pop_total[pop_total$sit=='Total',"2010"]%>%pull(),
    pop2022=pop_total[pop_total$sit=='Total',"2022"]%>%pull(),
    urban2000=pop_total[pop_total$sit=='Urbana',"2000"]%>%pull(),
    urban2010=pop_total[pop_total$sit=='Urbana',"2010"]%>%pull(),
    rur2000=pop_total[pop_total$sit=='Rural',"2000"]%>%pull(),
    rur2010=pop_total[pop_total$sit=='Rural',"2010"]%>%pull()
  )
temp_text<-list(
...
```{r}
rm_temp()
pop_munic<-read_rds('data/processed/pop_munic_nf.rds')

temp_numeric<-list(
    pop2000_macae=pop_munic[pop_munic$munic_co==3302403&
                              pop_munic$ano=='2000'&
                              pop_munic$sit=='total',"pop"]%>%pull(),
   pop2010_macae=pop_munic[pop_munic$munic_co==3302403&
                              pop_munic$ano=='2010'&
                              pop_munic$sit=='total',"pop"]%>%pull()
  )
temp_text<-list(
